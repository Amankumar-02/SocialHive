          ...
          <div className="container">
            <div id="card">
              <div id="topBar">
                <div id="topImg" className="flex items-center justify-center">
                  ...
                  <p className="text-xl ps-2 flex items-center justify-center">
                    {userDetails.name}
                    {/* <i className="ri-circle-fill text-green-600 text-xs"></i> */}
                    <svg
              ...
              {/* <div id="userDets"> */}
                <div id="first" className="flex items-start justify-evenly p-4">
                  ...
                  <div className="flex items-center justify-between ps-10 pt-3">
                    <div className="pe-6 text-center">
                      <p className="font-bold cursor-pointer">10</p>
                      <p className="text-sm">Posts</p>
                    </div>
                    <div className="pe-6 text-center">
                      <p className="font-bold cursor-pointer">{Math.floor(Math.random() * 100)}k</p>
                      <p className="text-sm">Followers</p>
                    </div>
                    <div className="text-center">
                      <p className="font-bold cursor-pointer">{Math.floor(Math.random() * 1000)}</p>
                ...
                >
                  <div>
                    <i className="ri-grid-line text-xl cursor-pointer"></i>
                  </div>
                  <div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                {/* <div id="four"> */}
                  <div id="userContainer">
                    ...
                    {postImg.map((src, index) => (
                      <div key={index}>
                        <Link to={`/user/previews/${index}`}>
                      <div className="userTab cursor-pointer" key={index}>
                        <img
                          src={src.dp}
                          alt={index}
